...
function onBtnRecordClicked (){
	if (localStream == null) {
		...
		mediaRecorder.onstop = function(){
			...
			// Assuming recordingBlob is the Blob object you want to send
				// Replace 'http://127.0.0.1:5000' with the actual address where your Flask app is running
				const apiUrl = 'http://127.0.0.1:5001/save_video';
